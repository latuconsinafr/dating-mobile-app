...
/**
 * Defines IsUserUsernameUnique validator constraint.
 */
@ValidatorConstraint({ async: true })
@Injectable()
export class IsUserUsernameUniqueValidator
...
/**
 * IsUserUsernameUnique decorator.
 *
 ...
 *
 * @returns IsUserUsernameUnique decorator
 */
export function IsUserUsernameUnique(
  ...
  return (object: any, propertyName: string) => {
    registerDecorator({
      ...
      validator: IsUserUsernameUniqueValidator,
    });
  };
}
