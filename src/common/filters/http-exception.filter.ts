...
export class HttpExceptionFilter implements ExceptionFilter {
   ...
   */
    ...
    const responseBody = {
      ...baseResponseBody,
      ...exceptionResponse,
      ...(httpStatus === 403 ? { help: DEFAULT_HELP_MESSAGE } : undefined), //! Forcing forbidden error to be exactly the same as the other exception error
      ...(httpStatus === 404 ? { help: DEFAULT_HELP_MESSAGE } : undefined), //! Forcing route not found error to be exactly the same as the other not found exception error
    };
